...
path = "/home/hanlv/workspace/code/research/infodemic/LLM/swift/examples/pytorch/llm/output/merlinite-7b/with_solar_info/brave/data1-split=8:2-ratio=1.0/adalora-r=3_8"
