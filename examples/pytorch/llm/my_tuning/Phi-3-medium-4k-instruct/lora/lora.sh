...
python llm_sft.py \
    ...
    --model_id_or_path /home/css/models/Phi-3-medium-4k-instruct \
    ...
    --output_dir output/Phi-3-medium-4k-instruct/$with_or_without_info/data$data_version-split=$split_type-ratio=$train_ratio/$sft_type-r=$lora_rank/"$output_name" \
