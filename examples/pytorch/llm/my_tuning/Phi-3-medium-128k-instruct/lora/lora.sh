...
python llm_sft.py \
    ...
    --output_dir output/Phi-3-medium-128k-instruct/$with_or_without_info/data$data_version-split=$split_type-ratio=$train_ratio/$sft_type-r=$lora_rank/"$output_name" \
