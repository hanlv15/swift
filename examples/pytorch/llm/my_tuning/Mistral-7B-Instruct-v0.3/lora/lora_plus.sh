...
python llm_sft.py \
    ...
    --output_dir output/Mistral-7B-Instruct-v0.3/$with_or_without_info/data$data_version-split=$split_type-ratio=$train_ratio/"$sft_type"_plus-r=$lora_rank/"$output_name" \
