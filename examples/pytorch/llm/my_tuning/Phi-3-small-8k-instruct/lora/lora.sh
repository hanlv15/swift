...
python llm_sft.py \
    --model_type phi-3-small-8k-instruct \
    --model_id_or_path /home/css/models/Phi-3-small-8k-instruct \
    ...
    --output_dir output/Phi-3-small-8k-instruct/$with_or_without_info/data$data_version-split=$split_type-ratio=$train_ratio/$sft_type-r=$lora_rank/"$output_name" \
