...
python llm_sft.py \
    ...
    --model_id_or_path /home/css/models/gemma-2-9b-it \
    ...
    --output_dir output/gemma-2-9b-it/$with_or_without_info/data$data_version-split=$split_type-ratio=$train_ratio/"$sft_type"_plus-r=$lora_rank/"$output_name" \
