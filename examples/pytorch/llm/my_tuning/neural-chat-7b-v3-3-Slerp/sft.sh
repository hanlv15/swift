...
torchrun \
    ...
    --model_cache_dir /home/css/models/neural-chat-7b-v3-3-Slerp \
    ...
    --output_dir output/neural-chat-7b-v3-3-Slerp/$with_or_without_info/data$data_version/lr=$learning_rate/"$output_name" \
    --ddp_backend nccl \
